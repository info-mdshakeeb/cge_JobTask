                ...
                <div className="2xl:mx-60 md:mx-10 mx-4 md:flex">
                    <div className="md:w-1/2">
                        <div className="xl:h-[326px] pt-3 xl:pt-[135px] text-[#102542]">
                            <p className=" font-bold text-7xl sxl:text-[100px] leading-[118px]">Start<span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#FFD33F] to-[#F45D02]">Mining</span> Today!</p>
                        </div>
