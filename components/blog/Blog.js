...
const Blog = () => {
    return (
        <section className="2xl:mx-60 md:mx-10 mx-4">
            ...
            <div className="flex gap-[10px] 2xl:gap-[20px] ">
                <div className="h-[550px] w-[462px] border border-[#FFD33F] rounded-[21px]">
                    <div className="mt-[36px] px-[29px] ">
                        <Image src={CartImg1} alt="img" />
                        <div className="mt-[25px] mb-[15px]">
                            <p className="text-[15px] font-[400] text-[#808682]">February 9, 2021</p>
                        </div>
                        <div className="w-[400px] text-[20px] text-[#180D5B] mb-[15px]">
